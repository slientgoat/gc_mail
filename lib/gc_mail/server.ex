defmodule GCMail.Server do
  use GenServer
  alias GCMail.Server, as: M
  alias GCMail.Mail
  import ShorterMaps
  require Logger
  ...
  # def submit_mail(key, attrs) do
  #   cast("#{key}", {:submit_mail, attrs})
  # end
  ...
  def handle_cast({:submit_mail, mail}, ~M{%M prepare_mails} = state) do
